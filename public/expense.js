    ...
    const options = {
      ...
      handler: async function(response) {
        ...
        try {
          ...
          document.getElementById('purchase').style.display = 'block';  // Show "You are Premium User"
          document.getElementById('purchase-premium').style.display = 'none';  // Hide "Purchase Premium Membership"
